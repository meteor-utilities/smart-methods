...
Mongo.Collection.prototype.smartMethods = function (options) {
  ...
  const createName = options.createName || collectionName+".create";
  const editName = options.editName || collectionName+".edit";
  const deleteName = options.deleteName || collectionName+".delete";

  methods[createName] = function (document) {
  ...
  methods[editName] = function (documentId, modifier) {
  ...
  methods[deleteName] = function (documentId) {
    ...
    if (options.deleteCallback && options.deleteCallback(currentUser, document) !== false) {
