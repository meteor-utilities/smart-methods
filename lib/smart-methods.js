...
Mongo.Collection.prototype.smartMethods = function (options) {
  ...
  methods[collectionName+".create"] = function (document) {
    ...
    _.keys(document).forEach(function (fieldName) {
      ...
      if (!canModifyDocumentField(currentUser, document, field)) {
  ...
  methods[collectionName+".delete"] = function (documentId) {
    ...
    if (options.deleteCallback && options.deleteCallback(currentUser, document)) {
...
const canModifyDocumentField = (user, document, field) => {
